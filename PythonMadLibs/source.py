...
What a strange event."""%(verbs[0],nouns[0],nouns[1],pluralnouns[2],nouns[3],verbs[1],adjectives[0],verbs[2],verbs[3],verbs[4],adjectives[1],nouns[4],verbs[5],nouns[5]
        ...
        print("""I have known Linda.for 20 years and %s recommend him/her for the position of assistant %s.in your
%s.company. I can't %s.enough about this person's %s.character and ability to get along with his/her fellow
%s. As for educational background, Linda is a college %s, is capable of speaking several foreign
%s, and has an IQ of 12. You will find Linda.to be a %s.worker who is not only
as smart as a %s, but who doesn't know the meaning of the word %s. Unfortunately, this is one of many words
this person doesn't know the meaning of"""%(adverbs[0], nouns[0], adjectives[0], verbs[0], adjectives[1], pluralnouns[0], nouns[1], pluralnouns[1], adjectives[2], nouns[2], verbs[1]))
